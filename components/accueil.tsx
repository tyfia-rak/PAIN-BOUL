      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
        <div className="lg:w-1/2">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-xl font-inter font-light leading-relaxed">
            Depuis 2018, nous perpétuons la tradition boulangère Malgache avec
            passion. Découvrez nos pains artisanaux, viennoiseries et
            pâtisseries préparés quotidiennement avec des ingrédients locaux.
          </p>
