...
import OrderFormModal from "@/components/menu/OrderFormModal";
          ...
          >
            ...
            <div className="p-6 border-b border-golden/10 bg-gradient-to-r from-background to-golden/5">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-playfair text-2xl text-foreground">Mon Panier</h4>
            ...
            <div className="flex-1 overflow-hidden flex flex-col">
              {items.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
                  ...
                  <div className="text-muted-foreground font-inter mb-6">Votre panier est vide</div>
                  {onClose && (
                    <button
                      onClick={handleClose}
                ...
                <>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-lg font-semibold text-golden">{(it.product.price ?? 0).toFixed(0)} Ar</div>
                          </div>
                          ...
                          <div className="flex items-center gap-1 bg-background rounded-full p-1 border border-golden/20">
                            ...
                            <span className="w-8 text-center font-inter font-medium text-foreground">{it.quantity}</span>
                            <button
                              onClick={() => updateQuantity(it.product.idProduct, it.quantity + 1)}
                              className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-golden/10 transition-all duration-200 active:scale-95 text-foreground"
                            >
                  ...
                  <div className="border-t border-golden/10 p-6 space-y-6 bg-background/80 backdrop-blur-sm">
                    <div className="flex items-center justify-between text-xl">
                      ...
                      <span className="font-playfair text-2xl font-bold text-golden">{totalPrice.toFixed(0)} Ar</span>
                    </div>
